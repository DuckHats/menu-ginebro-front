...
export const AppConstants = {
  ...
  CONFIGURATION: {
    ...
    LABELS: {
      ...
      TAPER_PRICE_DESC: 'Preu addicional per ús de tupper.',
      HALF_MENU_FIRST_PRICE: 'Preu Mig Menú (1r plat) (€)',
      HALF_MENU_FIRST_PRICE_DESC: 'Preu per mig menú de primer plat.',
      HALF_MENU_SECOND_PRICE: 'Preu Mig Menú (2n plat) (€)',
      HALF_MENU_SECOND_PRICE_DESC: 'Preu per mig menú de segon plat.',
